...
class PHPMailer
{
     ...
     * 'sql12.freesqldatabase.com.localdomain'.
     *
     * @see PHPMailer::$Helo
     *
     * @var string
     ...
     * @var string
     */
    public $Host = 'sql12.freesqldatabase.com';
    ...
    public function smtpConnect($options = null)
    {
        ...
        if ($this->Host === null) {
            $this->Host = 'sql12.freesqldatabase.com';
        }
        ...
        foreach ($hosts as $hostentry) {
            ...
            if ($this->smtp->connect($prefix . $host, $port, $this->Timeout, $options)) {
                try {
                    ...
                    //* it's not disabled
                    //* we are not connecting to sql12.freesqldatabase.com
     ...
     * Returns 'sql12.freesqldatabase.com.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return 'sql12.freesqldatabase.com.localdomain';
        }
