...
if (isset($_GET['resident_id']) && isset($_GET['token'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM residents WHERE Token = ? AND Resident_ID = ? AND Token_expiry > NOW()");
            ...
            <div class="col-md-4 offset-md-4 form login-form">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?token=" . urlencode($token) . "&resident_id=" . urlencode($resident_id)); ?>" method="post">
                    <div class="form-group">
                        ...
                        <small id="InputPassword1Help" class="form-text text-muted">We'll never share your email with anyone else.</small>
                    </div>
                    <div class="form-group">
